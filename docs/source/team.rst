            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        ...
                        <p class="text-muted para-desc mx-auto mb-0">WATRES was started at the Swiss Data Science Center at EPFL. The goal was to design a data-driven model to predict the transit time distributions of watersheds.</p>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
            <div class="col-12 text-center">
