.. WATRES documentation master file, created by
...
Documentation
~~~~~~~~~~~~~
`WATRES` is a package for learning transit time distributions characterizing the responses of watersheds. The package is developed and maintained by the `Swiss Data Science Center <https://www.datascience.ch/>`_ and the `Hydrology Group at Unil <https://wp.unil.ch/hydrology/paolo-benettin/>`_.



If you use `WATRES` in your work, please cite our publication.
...
.. raw:: html
         ...
         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 d-flex">
                ...
                <div class="card-body flex-fill">
                    ...
                    <p class="card-text">New to <em>WATRES</em>? Check out the installation guide.
                    </p>
...
.. container:: custom-button
    ...
    :doc:`To the documentation<documentation/WATRES>`
